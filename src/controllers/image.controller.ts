...
export class ImageController {
  ...
  async uploadImages(request: FastifyRequest, reply: FastifyReply): Promise<ProcessedImageResponse> {
    try {
      ...
      const result = await this.imageService.processMultipleImages(processedImages);
  ...
  async uploadImage(request: FastifyRequest, reply: FastifyReply): Promise<ProcessedImageResponse> {
    try {
      ...
      // Processa a imagem
      const result = await this.imageService.processImage(buffer, data.filename);
